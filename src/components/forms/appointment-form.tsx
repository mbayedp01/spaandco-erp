...
export function AddAppointmentButton({ staffNames, serviceNames }: Props) {
  ...
  return (
    <>
      ...
      <Modal open={open} onClose={() => setOpen(false)} title="Nouveau rendez-vous">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <select name="service_name" className={inputCls}>
                <option value="">— Choisir —</option>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input name="price" type="number" min="0" className={inputCls} placeholder="25000" />
            </div>
          </div>
