        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            ...
            <div>
              ...
              <input name="last_name" required className={inputCls} placeholder="Diop" />
            </div>
          </div>
          <div>
            <label className={labelCls}>Email</label>
            <input name="email" type="email" className={inputCls} placeholder="email@exemple.com" />
          </div>
          <div>
            <label className={labelCls}>Téléphone</label>
            <input name="phone" className={inputCls} placeholder="+221 77 000 00 00" />
          </div>
